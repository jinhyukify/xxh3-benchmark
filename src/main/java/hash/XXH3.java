...
public class XXH3 extends Hash {
    ...
    static final long DEFAULT_SECRET_BITFLIP_0 =
            ((DEFAULT_SECRET_LONG_0 >>> 32) ^ (DEFAULT_SECRET_LONG_0 & MASK32));
    static final long DEFAULT_SECRET_BITFLIP_1 = (DEFAULT_SECRET_LONG_1 ^ DEFAULT_SECRET_LONG_2);
    static final long DEFAULT_SECRET_BITFLIP_2 = (DEFAULT_SECRET_LONG_3 ^ DEFAULT_SECRET_LONG_4);
    ...
    @VisibleForTesting
    <T> long hashSmall(HashKey<T> hashKey, int length, long seed) {
        if (length > 8) {
    ...
    private <T> long hashLength129To240(HashKey<T> hashKey, int length, long seed) {
        ...
        switch ((length - 128) >> 4) {
            case 7:
                acc += mix16(hashKey, 16 * 14, DEFAULT_SECRET_3_LONG_12,
                             DEFAULT_SECRET_3_LONG_13, seed);
            case 6:
                acc += mix16(hashKey, 16 * 13, DEFAULT_SECRET_3_LONG_10,
                             DEFAULT_SECRET_3_LONG_11, seed);
            case 5:
                acc += mix16(hashKey, 16 * 12, DEFAULT_SECRET_3_LONG_8,
                             DEFAULT_SECRET_3_LONG_9, seed);
            case 4:
                acc += mix16(hashKey, 16 * 11, DEFAULT_SECRET_3_LONG_6,
                             DEFAULT_SECRET_3_LONG_7, seed);
            case 3:
                acc += mix16(hashKey, 16 * 10, DEFAULT_SECRET_3_LONG_4,
                             DEFAULT_SECRET_3_LONG_5, seed);
            case 2:
                acc += mix16(hashKey, 16 * 9, DEFAULT_SECRET_3_LONG_2,
                             DEFAULT_SECRET_3_LONG_3, seed);
            case 1:
                acc += mix16(hashKey, 16 * 8, DEFAULT_SECRET_3_LONG_0,
                             DEFAULT_SECRET_3_LONG_1, seed);
            case 0:
    ...
    <T> long hashLarge(HashKey<T> hashKey, int length, long seed) {
        long acc0 = PRIME32_3;
        long acc1 = PRIME64_1;
        long acc2 = PRIME64_2;
        long acc3 = PRIME64_3;
